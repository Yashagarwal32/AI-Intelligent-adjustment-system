...
class Application:
    def __init__(self,master):
        ...
        self.c=Canvas(self.front,width=1270,height=720,bg='yellow')
        self.c.pack(expand=YES,fill=BOTH)
        self.g=PhotoImage(file='C:\\Users\\YASH NAREDI AGARWAL\\Desktop\\ai wallpapers converted\\aa11.png')
        self.c.create_image(635,0,image=self.g,anchor=N)
        ...
        self.manager.place(x=500,y=400)
    ...
    def managers_entry(self):
        ...
        self.c1=Canvas(self.manage,width=1270,height=720,bg='yellow')
        self.c1.pack(expand=YES,fill=BOTH)
        self.g1=PhotoImage(file='C:\\Users\\YASH NAREDI AGARWAL\\Desktop\\ai wallpapers converted\\aa2.png')
        self.c1.create_image(635,0,image=self.g1,anchor=N)
    ...
    def manage_sectionsf(self):        
        ...
        self.c5=Canvas(self.left,width=1270,height=720,bg='yellow')
        self.c5.pack(expand=YES,fill=BOTH)
        self.g5=PhotoImage(file='C:\\Users\\YASH NAREDI AGARWAL\\Desktop\\ai wallpapers converted\\aa5.png')
        self.c5.create_image(635,0,image=self.g5,anchor=N)
        #LABELS=======

        self.heading=Label(self.left,text="Section Details",font=('arial 25 bold'),fg='white',bg='black')
        self.heading.place(x=500,y=0)

        self.sectionname=Label(self.left,text="Section name",font=('arial 20 bold'),fg='white',bg='black')
        self.sectionname.place(x=450,y=50)

        self.day=Label(self.left,text="Day",font=('arial 18 bold'),fg='white',bg='black')
        self.day.place(x=0,y=140)
        
        self.slot1=Label(self.left,text="Slot1",font=('arial 18 bold'),fg='white',bg='black')
        self.slot1.place(x=0,y=180)

        self.slot2=Label(self.left,text="Slot2",font=('arial 18 bold'),fg='white',bg='black')
        self.slot2.place(x=0,y=220)

        self.slot3=Label(self.left,text="Slot3",font=('arial 18 bold'),fg='white',bg='black')
        self.slot3.place(x=0,y=260)

        self.slot4=Label(self.left,text="Slot4",font=('arial 18 bold'),fg='white',bg='black')
        self.slot4.place(x=0,y=300)

        self.slot5=Label(self.left,text="Slot5",font=('arial 18 bold'),fg='white',bg='black')
        self.slot5.place(x=0,y=340)

        self.slot6=Label(self.left,text="Slot6",font=('arial 18 bold'),fg='white',bg='black')
        self.slot6.place(x=0,y=380)

        self.subject1=Label(self.left,text="Subject 1",font=('arial 18 bold'),fg='white',bg='black')
        self.subject1.place(x=625,y=140)

        self.subject2=Label(self.left,text="Subject 2",font=('arial 18 bold'),fg='white',bg='black')
        self.subject2.place(x=625,y=180)

        self.subject3=Label(self.left,text="Subject 3",font=('arial 18 bold'),fg='white',bg='black')
        self.subject3.place(x=625,y=220)

        self.subject4=Label(self.left,text="Subject 4",font=('arial 18 bold'),fg='white',bg='black')
  ...
  #=========testing===============
    ...
    def manage_teachersf(self):
        ...
        self.c4=Canvas(self.mteacher,width=1270,height=720,bg='yellow')
        self.c4.pack(expand=YES,fill=BOTH)
        self.g4=PhotoImage(file='C:\\Users\\YASH NAREDI AGARWAL\\Desktop\\ai wallpapers converted\\aa6.png')
        self.c4.create_image(635,0,image=self.g4,anchor=N)
        #LABELS=======

        self.heading=Label(self.mteacher,text="Faculty Details",font=('arial 25 bold'),fg='white',bg='black')
        self.heading.place(x=500,y=0)
        self.pdetails=Label(self.mteacher,text="Personal Details....",font=('arial 20 bold'),fg='white',bg='black')
        self.pdetails.place(x=0,y=70)
        self.fname=Label(self.mteacher,text="Name",font=('arial 20 bold'),fg='white',bg='black')
        self.fname.place(x=0,y=160)

        self.fuid=Label(self.mteacher,text="UID",font=('arial 18 bold'),fg='white',bg='black')
        self.fuid.place(x=0,y=200)
   
        self.fgender=Label(self.mteacher,text="Gender",font=('arial 18 bold'),fg='white',bg='black')
        self.fgender.place(x=0,y=240)
        
        self.fdob=Label(self.mteacher,text="Date of Birth",font=('arial 18 bold'),fg='white',bg='black')
        self.fdob.place(x=0,y=280)
        
        self.fsalary=Label(self.mteacher,text="Salary",font=('arial 18 bold'),fg='white',bg='black')
        self.fsalary.place(x=0,y=320)
        
        self.adetails=Label(self.mteacher,text="Subjects Details....",font=('arial 20 bold'),fg='white',bg='black')
        self.adetails.place(x=625,y=70)
        self.fsubject1=Label(self.mteacher,text="Subject 1",font=('arial 18 bold'),fg='white',bg='black')
        self.fsubject1.place(x=625,y=160)

        self.fsubject2=Label(self.mteacher,text="Subject 2",font=('arial 18 bold'),fg='white',bg='black')
        self.fsubject2.place(x=625,y=200)

        self.fsubject3=Label(self.mteacher,text="Subject 3",font=('arial 18 bold'),fg='white',bg='black')
        self.fsubject3.place(x=625,y=240)

        self.fsubject4=Label(self.mteacher,text="Subject 4",font=('arial 18 bold'),fg='white',bg='black')
        self.fsubject4.place(x=625,y=280)

        self.adetails=Label(self.mteacher,text="Section Details....",font=('arial 20 bold'),fg='white',bg='black')
        self.adetails.place(x=0,y=430)

        self.fsection1=Label(self.mteacher,text="Section 1",font=('arial 18 bold'),fg='white',bg='black')
        self.fsection1.place(x=0,y=500)

        self.fsection2=Label(self.mteacher,text="Section 2",font=('arial 18 bold'),fg='white',bg='black')
  ...
  #=========testing===============
        if self.valu1=="" or self.valu2=="" or self.valu3=="" or self.valu4=="" or self.valu5=="" or self.valu6=="" or self.valu7=="" or self.valu8=="" or self.valu9=="" or self.valu10=="" or self.valu11=="":
            ...
            q=c.execute('SELECT * from teachertime1 where uid="%s"' %(self.valu2))
            if(c.fetchone() is not None):
                tkinter.messagebox.showinfo("warning","UID already exist.")
                
            else:
                q=c.execute('SELECT * from sectiontime where name="%s"' %(self.valu10))
                if(c.fetchone() is None):
                    tkinter.messagebox.showinfo("warning","Section1 does not exist.")
                else:
                    q=c.execute('SELECT * from sectiontime where name="%s"' %(self.valu11))
                    if(c.fetchone() is None):
                        tkinter.messagebox.showinfo("warning","Section2 does not exist.")
                    else:
    ...
    def manage_students(self):
        ...
        self.c2=Canvas(self.mstudents,width=1270,height=720,bg='yellow')
        self.c2.pack(expand=YES,fill=BOTH)
        self.g2=PhotoImage(file='C:\\Users\\YASH NAREDI AGARWAL\\Desktop\\ai wallpapers converted\\ngit7.png')
        self.c2.create_image(635,0,image=self.g2,anchor=N)
        #LABELS=======

        self.heading=Label(self.mstudents,text="Student Details",font=('arial 25 bold'),fg='white',bg='black')
        self.heading.place(x=500,y=0)
        
        self.pedetails=Label(self.mstudents,text="Personal Details....",font=('arial 20 bold'),fg='white',bg='black')
        self.pedetails.place(x=0,y=70)
        
        self.stname=Label(self.mstudents,text="Name",font=('arial 20 bold'),fg='white',bg='black')
        self.stname.place(x=0,y=160)

        self.stuid=Label(self.mstudents,text="Registration ID",font=('arial 18 bold'),fg='white',bg='black')
        self.stuid.place(x=0,y=200)
   
        self.stgender=Label(self.mstudents,text="Gender",font=('arial 18 bold'),fg='white',bg='black')
        self.stgender.place(x=0,y=240)
        
        self.stsection=Label(self.mstudents,text="Section",font=('arial 18 bold'),fg='white',bg='black')
  ...
  #=========testing===============
        if self.value1=="" or self.value2=="" or self.value3=="" or self.value4=="":
            ...
            #for row in c.execute('select * from studentdetails'):
                #print(row)
        elif len(self.value2)!=8:
            tkinter.messagebox.showinfo("warning","Registration number should be of 8 characters.")
            

        else:
            #c.execute("create table studentdetails(name text,uid text,gender text,section text,password text default '12345678')")
            q=c.execute('SELECT * from studentdetails where uid="%s"' %(self.value2))
    
            if c.fetchone() is not None :
                tkinter.messagebox.showinfo("warning","Registeration number already exist.")
                
            else:
                q1=c.execute('SELECT * from sectiontime where name="%s"' %(self.value4))
                if c.fetchone() is None :
                    tkinter.messagebox.showinfo("warning","Section does not exist")
                else:    
    ...
    def student_login(self):
        ...
        self.c6=Canvas(self.studente,width=1270,height=720,bg='yellow')
        self.c6.pack(expand=YES,fill=BOTH)
        self.g6=PhotoImage(file='C:\\Users\\YASH NAREDI AGARWAL\\Desktop\\ai wallpapers converted\\aa6.png')
        self.c6.create_image(635,0,image=self.g6,anchor=N)
        self.studentlogi=Frame(self.studente,width=450,height=280,bg='black')
        self.studentlogi.place(x=410,y=200)
        
        self.c9=Canvas(self.studentlogi,width=450,height=280,bg='yellow')
        self.c9.pack(expand=YES,fill=BOTH)
        self.g9=PhotoImage(file='C:\\Users\\YASH NAREDI AGARWAL\\Desktop\\ai wallpapers converted\\aa9.png')
        self.c9.create_image(225,0,image=self.g9,anchor=N)
    ...
    def temporary_login(self):
        ...
        self.studentlogi=Frame(self.studente,width=450,height=280,bg='black')
        self.studentlogi.place(x=410,y=200)
        self.c50=Canvas(self.studentlogi,width=450,height=280,bg='yellow')
        self.c50.pack(expand=YES,fill=BOTH)
        self.g50=PhotoImage(file='C:\\Users\\YASH NAREDI AGARWAL\\Desktop\\ai wallpapers converted\\aa9.png')
        self.c50.create_image(225,0,image=self.g50,anchor=N)
        self.studentlogi=Frame(self.studente,width=450,height=280,bg='black')
        self.studentlogi.place(x=410,y=200)
        self.heading1=Label(self.studentlogi,text="Student Login ",font=('arial 22 bold'),fg='white',bg='black')
        self.heading1.place(x=140,y=10)
    ...
    def temporary1_login(self):
        ...
        self.studentlogi=Frame(self.studente,width=450,height=280,bg='black')
        self.studentlogi.place(x=410,y=200)
        self.c51=Canvas(self.studentlogi,width=450,height=280,bg='yellow')
        self.c51.pack(expand=YES,fill=BOTH)
        self.g51=PhotoImage(file='C:\\Users\\YASH NAREDI AGARWAL\\Desktop\\ai wallpapers converted\\aa9.png')
        self.c51.create_image(225,0,image=self.g51,anchor=N)
        self.studentlogi=Frame(self.studente,width=450,height=280,bg='black')
        self.studentlogi.place(x=410,y=200)
        self.heading1=Label(self.studentlogi,text="Student Login ",font=('arial 22 bold'),fg='white',bg='black')
        self.heading1.place(x=140,y=10)
    ...
    def student_fp(self):
        ...
        self.c10=Canvas(self.studentlogif,width=450,height=260,bg='yellow')
        self.c10.pack(expand=YES,fill=BOTH)
        self.g10=PhotoImage(file='C:\\Users\\YASH NAREDI AGARWAL\\Desktop\\ai wallpapers converted\\aa9.png')
        self.c10.create_image(225,0,image=self.g10,anchor=N)
        ...
        if self.gt1=="" or self.gt2=="":
            ...
            if c.fetchone() is  not None :
                ...
                if c.fetchone() is  not None :
                    ...
                    #print(pop1)
                    self.fostnamem_var.set("");
                    self.fostpassword_var.set("");
                else:
    ...
    def student_cp(self):
        ...
        self.c11=Canvas(self.studentlogic,width=450,height=330,bg='yellow')
        self.c11.pack(expand=YES,fill=BOTH)
        self.g11=PhotoImage(file='C:\\Users\\YASH NAREDI AGARWAL\\Desktop\\ai wallpapers converted\\aa10.png')
        self.c11.create_image(225,0,image=self.g11,anchor=N)
        ...
        if self.inputst1=="" or self.inputst2=="" or self.inputst3=="" or self.inputst4=="":
            ...
            if c.fetchone() is  not None :
                ...
                if c.fetchone() is  not None :
                    ...
                    self.chstnamem_var.set("");
                    self.chstpassword_var.set("");
                    self.chstpass1_var.set("");
                    self.chstpass2_var.set("");
    ...
    def student_entry(self):
        ...
        if self.input1=="" or self.input2=="":
            ...
            if c.fetchone() is  not None :
                ...
                if c.fetchone() is  not None :
                    dsd=c.execute('SELECT * from studentdetails')
                    dsd1=c.fetchall()
                    print("student details",dsd1)
                    tkinter.messagebox.showinfo("success","Login Successfully.")
                    self.stnamem_var.set("");
                    self.stpassword_var.set("");
                    self.studente.destroy()
                    ...
                    self.stsback=Button(self.studente1,text="LogOut",width=8,height=1,bg='red',command=self.back7_db)
    ...
    def teacher_login(self):
        ...
        self.c7=Canvas(self.teachere,width=1270,height=720,bg='yellow')
        self.c7.pack(expand=YES,fill=BOTH)
        self.g7=PhotoImage(file='C:\\Users\\YASH NAREDI AGARWAL\\Desktop\\ai wallpapers converted\\aa6.png')
        self.c7.create_image(635,0,image=self.g7,anchor=N)
        
        self.teacherlogi=Frame(self.teachere,width=450,height=260,bg='black')
        self.teacherlogi.place(x=410,y=200)
        
        self.c8=Canvas(self.teacherlogi,width=450,height=260,bg='yellow')
        self.c8.pack(expand=YES,fill=BOTH)
        self.g8=PhotoImage(file='C:\\Users\\YASH NAREDI AGARWAL\\Desktop\\ai wallpapers converted\\aa8.png')
        self.c8.create_image(225,0,image=self.g8,anchor=N)
        ...
        if self.inteacher1=="" or self.inteacher2=="":
            ...
            if c.fetchone() is  not None :
                ...
                if c.fetchone() is  not None :
                    ...
                    self.logs2.place(x=10,y=100)
                   
                    self.box2=Text(self.teachere2,width=55,height=40)
                    self.box2.place(x=20,y=150)
                    ...
                    self.stsfback=Button(self.teachere1,text="LogOut",width=8,height=1,bg='red',command=self.back8_db)
                    ...
                    self.sstleave4=Label(self.teachere2,text="Leave",font=('arial 16 bold'),fg='white',bg='black')
                    self.sstleave4.place(x=10,y=20)
                    self.applyleave=Button(self.teachere2,text="Apply Leave",width=20,height=1,bg='steelblue',command=self.leave_db)
                    self.applyleave.place(x=10,y=60)
                    #self.tleave_ent=Entry(self.teachere1,textvariable=self.tleave_var,width=30)
                    #self.tleave_ent.place(x=200,y=500)
                    self.tleave_ent=ttk.Combobox(self.teachere2,textvariable=self.tleave_var,width=27,state="readonly")
                    self.tleave_ent['values']=('yes')
                    self.tleave_ent.place(x=200,y=20)
                    self.cancelleave=Button(self.teachere2,text="Cancel Leave",width=20,height=1,bg='steelblue',command=self.cancelleave_db)
                    self.cancelleave.place(x=200,y=60)
                    ...
                    if('yes' in ty2):
                        ...
                        sd12=c.fetchall()
                        #print('sd',sd12)
                        print(sd2 is not None)
                        if(len(sd2)!=0):
                            print("sd1",sd2)
                            self.box2.insert(END,"Adjustment has done by your colleague \n"+"with id : "+sd2[0][0]+"\nfor section : "+sd2[0][1]+"  time : "+sd2[0][3]+"\n")
                            

                        if(len(sd4)!=0):
                            self.box2.insert(END,"Adjustment has done by your colleague \n"+"with id : "+sd4[0][0]+"\nfor section : "+sd4[0][1]+"  time : "+sd4[0][3]+"\n")

                        if(len(sd6)!=0):
                            self.box2.insert(END,"Adjustment has done by your colleague \n"+"with id : "+sd6[0][0]+"\nfor section : "+sd6[0][1]+"  time : "+sd6[0][3]+"\n") 

                        if(len(sd8)!=0):
                            self.box2.insert(END,"Adjustment has done by your colleague \n"+"with id : "+sd8[0][0]+"\nfor section : "+sd8[0][1]+"  time : "+sd8[0][3]+"\n")

                        if(len(sd10)!=0):
                            self.box2.insert(END,"Adjustment has done by your colleague \n"+"with id : "+sd10[0][0]+"\nfor section : "+sd10[0][1]+"  time : "+sd10[0][3]+"\n")   

                        if(len(sd12)!=0):
                            self.box2.insert(END,"Adjustment has done by your colleague \n"+"with id : "+sd12[0][0]+"\nfor section : "+sd12[0][1]+"  time : "+sd12[0][3])
    ...
    def teacher_entry1(self):
            ...
            self.ssheading3=Label(self.teachere1,text="Time Table....",font=('arial 20 bold'),fg='white',bg='blue')
            self.ssheading3.place(x=250,y=400)
